      ...
      <div className="header2">
        ...
        <ul className="navigation">
          ...
          <li className="user-dropdown">
            {user ? (
              <>
                <span className="welcome-text">Welcome, {user.username || user.name}</span>
      ...
      <section>
        ...
        <div className="content">
          <div className="textBox">
            ...
            <p>
              At Emerald Vineyard, every bottle tells a story of dedication and
              sustainability. Our grapes are nurtured in sun-drenched,
              emerald-green fields, where fertile soil and careful cultivation
              come together to produce wines of unparalleled depth and character.
            </p>
            <a href="/">Learn More</a>
          </div>
